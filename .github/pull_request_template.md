...
- [ ] Tested with AI agent(s): <!-- specify which: Copilot, Claude, Cursor, Gemini, Qwen, opencode, etc. -->
- [ ] Tested commands: <!-- e.g., /speckit.plan, /speckit.spec, /speckit.understand -->
...
- [ ] AGENTS.md protocol
- [ ] command-rules.md
- [ ] Memory files (constitution.md, etc.)
- [ ] Other: <!-- specify -->
